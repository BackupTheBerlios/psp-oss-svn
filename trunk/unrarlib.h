...
#define _DEBUG_LOG_FILE "debug_unrar.txt" /* log file path        */
#else
...
extern int urarlib_get(void *output, unsigned long *size, char *filename, FILE *rarpointer, char *libpassword);
